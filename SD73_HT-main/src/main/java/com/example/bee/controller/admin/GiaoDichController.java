...
public class GiaoDichController {
    ...
    public ResponseEntity<?> updateStatusTransaction(@PathVariable("id") Long id, @RequestBody UpdatedGiaoDichRequest updatedGiaoDichRequest) {
        return ResponseEntity.ok(giaoDichService.updateStatusTrans(id, updatedGiaoDichRequest));
    }
